...
plt.scatter(Divide[0], Divide[1], label='Division', c='blue')
...
##Resultant Vector
plt.quiver(Vector2[0], Vector2[1], Vector1[0], Vector1[1], angles='xy', scale_units='xy', scale=1, color='mistyrose')
plt.quiver(-20, -5, Vector4[0], Vector4[1], angles='xy', scale_units='xy', scale=1, color='lemonchiffon')
Vector6 = Vector2 + Vector4
plt.quiver(Vector2[0], Vector2[1], Vector6[0], Vector6[1], angles='xy', scale_units='xy', scale=1, color='skyblue')
